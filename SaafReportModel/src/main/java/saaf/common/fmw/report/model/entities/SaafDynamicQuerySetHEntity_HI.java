...
public class SaafDynamicQuerySetHEntity_HI {
    ...
    @Id    
    @GeneratedValue
    @Column(name = "query_set_header_id", nullable = false, length = 11)    
    ...
    @Column(name = "query_set_num", nullable = false, length = 30)    
    public String getQuerySetNum() {
	return querySetNum;
    }

    public void setFunctionTabName(String functionTabName) {
	this.functionTabName = functionTabName;
    }

    @Column(name = "function_tab_name", nullable = true, length = 30)    
    public String getFunctionTabName() {
	return functionTabName;
    }
    ...
    @Column(name = "charts_title", nullable = true, length = 30)
	...
	@Column(name = "flex_values_type", nullable = true, length = 30)
	public String getFlexValuesType() {
		return flexValuesType;
	}

	public void setFlexValuesType(String flexValuesType) {
		this.flexValuesType = flexValuesType;
	}
    ...
    @Column(name = "web_script", nullable = true, length = 0)    
    ...
    @Column(name = "count_sql", nullable = true, length = 0)    
    ...
    @Column(name = "data_source", nullable = true, length = 0)    
    ...
    @Column(name = "where_clause", nullable = true, length = 0)    
    ...
    @Column(name = "query_flag", nullable = true, length = 30)    
    ...
    @Column(name = "frozen_number", nullable = true, length = 11)    
    public Integer getFrozenNumber() {
	return frozenNumber;
    }

    public void setShowSeqFlag(String showSeqFlag) {
	this.showSeqFlag = showSeqFlag;
    }

    @Column(name = "show_seq_flag", nullable = true, length = 30)    
    public String getShowSeqFlag() {
	return showSeqFlag;
    }
