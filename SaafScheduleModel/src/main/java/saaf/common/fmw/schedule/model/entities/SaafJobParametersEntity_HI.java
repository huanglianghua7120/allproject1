...
@Entity
@Table(name = "saaf_job_parameters")
public class SaafJobParametersEntity_HI {

    public SaafJobParametersEntity_HI() {
        super();
    }
    ...
    @Id
    @SequenceGenerator(name = "SAAF_JOB_PARAMETERS_S", sequenceName = "SAAF_JOB_PARAMETERS_S", allocationSize = 1)
    @GeneratedValue(generator = "SAAF_JOB_PARAMETERS_S", strategy = GenerationType.SEQUENCE)
