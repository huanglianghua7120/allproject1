...
/**
 * SaafRespMenuEntity_HI Entity Object
 * Thu Apr 20 11:13:31 CST 2017  Auto Generate
 */
@Entity
@Table(name = "saaf_resp_menu")
public class SaafRespMenuEntity_HI {
    ...
    @Id
    @SequenceGenerator(name = "SAAF_RESP_MENU_S", sequenceName = "SAAF_RESP_MENU_S", allocationSize = 1)
    @GeneratedValue(generator = "SAAF_RESP_MENU_S", strategy = GenerationType.SEQUENCE)
    @Column(name = "resp_menu_id", precision = 22, scale = 0)
