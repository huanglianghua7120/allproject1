package saaf.common.fmw.rule.constant;
...
public class Constant {
    ...
    public static final String BUSINESSLINE_CODE = "BUSINESSLINE";
    public static final String WEBSERVICE_CODE = "SERVICE_SEQ_";
    public static final String BUSINESSLINE_SEQ = "BUSINESSLINE_SEQ";
    public static final String MODELCODE_SEQ = "MODELCODE_";
