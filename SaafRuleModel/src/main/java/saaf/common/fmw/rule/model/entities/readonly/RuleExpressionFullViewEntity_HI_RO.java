...
public class RuleExpressionFullViewEntity_HI_RO {
    ...
    public static final String QUERY_SQL = "select " +
            ...
            "       and now() BETWEEN ifnull(rule_exp.effect_date,now()-1) AND ifnull(rule_exp.effect_end_date,now()+1) AND rule_exp_dim.rule_business_line_code = dim.rule_business_line_code AND dim.RULE_DIM_CODE = rule_exp_dim.RULE_DIM_CODE";
    ...
    public static final String query = "SELECT" +
            ...
            "    ON rule_exp.RULE_EXP_CODE = rule_exp_dim.RULE_EXP_CODE AND now() BETWEEN ifnull(rule_exp.effect_date, now() - 1) AND ifnull(rule_exp.effect_end_date, now() + 1)\n" +
