...
public class Util {
     ...
     * @return
     */
    public static Pagination autoSearchPagination(BaseViewObject dao, String sql, com.alibaba.fastjson.JSONObject params, int pagIndex, int pageRows, String sort, Map map1) {
     ...
     * @return
     */
    public static Pagination autoSearchPagination(BaseViewObject dao, String sql, com.alibaba.fastjson.JSONObject params, int pagIndex, int pageRows) {
     ...
     * 自动查询功能
     */
    public static Pagination autoSearchPagination(BaseViewObject dao, String sql, com.alibaba.fastjson.JSONObject params, int pagIndex, int pageRows, String sort) {
     ...
     * 自动查询功能
     */
    public static Pagination autoSearchPagination(BaseViewObject dao, String sql, com.alibaba.fastjson.JSONObject params, int pagIndex, int pageRows, Map map) {
     ...
     * @return
     */
    public static Pagination autoSearchPagination(BaseViewObject dao, String sql, String[] sqlName, String[] attributeName, com.alibaba.fastjson.JSONObject params, int pagIndex, int pageRows,
