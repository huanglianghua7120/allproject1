...
/**
 * SrmPonJuryCountersignsEntity_HI Entity Object
 * Tue Apr 17 11:14:38 CST 2018  Auto Generate
 */
@Entity
@Table(name = "srm_pon_jury_countersigns")
public class SrmPonJuryCountersignsEntity_HI {
	...
	@Column(name = "jury_countersign_id", nullable = false, length = 11)	
	...
	@Column(name = "round", nullable = true, length = 11)	
	...
	@Column(name = "countersign_opinion", nullable = true, length = 30)	
	...
	@Column(name = "countersign_comments", nullable = true, length = 2000)	
