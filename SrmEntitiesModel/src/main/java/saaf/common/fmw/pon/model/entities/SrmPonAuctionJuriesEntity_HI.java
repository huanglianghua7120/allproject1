...
/**
 * SrmPonAuctionJuriesEntity_HI Entity Object
 * Tue Apr 17 11:14:29 CST 2018  Auto Generate
 */
@Entity
@Table(name = "srm_pon_auction_juries")
public class SrmPonAuctionJuriesEntity_HI {
	...
	@Id
	@SequenceGenerator(name = "SRM_PON_AUCTION_JURIES_S", sequenceName = "SRM_PON_AUCTION_JURIES_S", allocationSize = 1)
	@GeneratedValue(generator = "SRM_PON_AUCTION_JURIES_S", strategy = GenerationType.SEQUENCE)
	@Column(name = "jury_id", nullable = false, length = 11)	
	...
	@Column(name = "user_duty", nullable = true, length = 30)	
	...
	@Column(name = "jury_status", nullable = true, length = 30)	
