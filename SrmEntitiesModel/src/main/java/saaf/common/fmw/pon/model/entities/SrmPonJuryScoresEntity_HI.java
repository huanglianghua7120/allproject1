...
/**
 * SrmPonJuryScoresEntity_HI Entity Object
 * Tue Apr 17 11:14:35 CST 2018  Auto Generate
 */
@Entity
@Table(name = "srm_pon_jury_scores")
public class SrmPonJuryScoresEntity_HI {
	...
	@Column(name = "score_comments", nullable = true, length = 240)	
	...
	@Column(name = "score_file_id", nullable = true, length = 11)	
