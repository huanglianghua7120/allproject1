...
/**
 * SrmPonAuctionItemLaddersEntity_HI Entity Object
 * Tue Apr 17 11:14:26 CST 2018  Auto Generate
 */
@Entity
@Table(name = "srm_pon_auction_item_ladders")
public class SrmPonAuctionItemLaddersEntity_HI {
	...
	@Column(name = "item_ladder_id", nullable = false, length = 11)	
	...
	@Column(name = "ladder_quantity", precision = 15, scale = 3)	
