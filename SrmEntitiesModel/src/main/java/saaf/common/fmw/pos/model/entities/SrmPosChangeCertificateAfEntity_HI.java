...
/**
 * SrmPosChangeCertificateAfEntity_HI Entity Object
 * Thu Mar 15 16:20:56 CST 2018  Auto Generate
 */
@Entity
@Table(name = "srm_pos_change_certificate_af")
public class SrmPosChangeCertificateAfEntity_HI {
	...
	@Column(name = "change_certificate_af_id", nullable = false, length = 11)	
