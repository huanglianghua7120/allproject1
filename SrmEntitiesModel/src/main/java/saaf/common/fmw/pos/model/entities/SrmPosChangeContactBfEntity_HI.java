...
/**
 * SrmPosChangeContactBfEntity_HI Entity Object
 * Fri Mar 16 17:43:16 CST 2018  Auto Generate
 */
@Entity
@Table(name = "srm_pos_change_contact_bf")
public class SrmPosChangeContactBfEntity_HI {
	...
	@Column(name = "change_contact_bf_id", nullable = false, length = 11)	
