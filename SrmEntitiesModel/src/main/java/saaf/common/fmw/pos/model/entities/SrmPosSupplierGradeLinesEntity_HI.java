...
/**
 * SrmPosSupplierGradeLinesEntity_HI Entity Object
 * Mon Sep 03 17:57:53 CST 2018  Auto Generate
 */
@Entity
@Table(name = "srm_pos_supplier_grade_lines")
public class SrmPosSupplierGradeLinesEntity_HI {
    ...
    private String autoInvalidFlag;
    ...
    @Column(name = "grade_line_id", nullable = false, length = 11)    
    ...
    @Column(name = "comprehensive_score", precision = 22, scale = 2)    
    ...
    @Column(name = "adjust_grade", nullable = false, length = 30)    
    ...
    @Column(name = "line_note", nullable = true, length = 2000)    
    ...
    public void setAutoInvalidFlag(String autoInvalidFlag) {
	this.autoInvalidFlag = autoInvalidFlag;
    }

    @Column(name = "auto_invalid_flag", nullable = true, length = 1)    
    public String getAutoInvalidFlag() {
	return autoInvalidFlag;
    }
