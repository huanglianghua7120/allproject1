...
/**
 * SrmPosInvestigationPlanCategoriesEntity_HI Entity Object
 * Fri Dec 14 11:50:22 CST 2018  Auto Generate
 */
@Entity
@Table(name="srm_pos_investigation_plan_categories")
public class SrmPosInvestigationPlanCategoriesEntity_HI {
	...
	@Column(name="investigation_plan_categories_id", nullable=false, length=11)	
