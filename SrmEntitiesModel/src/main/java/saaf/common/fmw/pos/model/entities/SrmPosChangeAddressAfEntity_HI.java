...
/**
 * SrmPosChangeAddressAfEntity_HI Entity Object
 * Mon Mar 19 11:49:02 CST 2018  Auto Generate
 */
@Entity
@Table(name = "srm_pos_change_address_af")
public class SrmPosChangeAddressAfEntity_HI {
	...
	@Column(name = "change_address_af_id", nullable = false, length = 11)	
