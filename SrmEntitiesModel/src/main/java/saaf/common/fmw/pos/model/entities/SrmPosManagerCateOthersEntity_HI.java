...
/**
 * SrmPosManagerCateOthersEntity_HI Entity Object
 * Wed Nov 15 10:54:19 CST 2017  Auto Generate
 */
@Entity
@Table(name = "srm_pos_manager_cate_others")
public class SrmPosManagerCateOthersEntity_HI {
    ...
    @Column(name = "other_category_id", nullable = false, length = 11)    
