...
/**
 * SrmPosSupplierQuitEntity_HI Entity Object
 * Wed Nov 15 10:56:28 CST 2017  Auto Generate
 */
@Entity
@Table(name = "srm_pos_supplier_quit")
public class SrmPosSupplierQuitEntity_HI {
    ...
    @Column(name = "frozen_id", nullable = true, length = 11)    
    ...
    @Column(name = "inventory_cleanup_flag", nullable = true, length = 10)    
    ...
    @Column(name = "payment_settle_flag", nullable = true, length = 10)    
    ...
    @Column(name = "quit_date", nullable = true, length = 11)
    ...
    @Column(name = "quit_forever_flag", nullable = true, length = 1)
