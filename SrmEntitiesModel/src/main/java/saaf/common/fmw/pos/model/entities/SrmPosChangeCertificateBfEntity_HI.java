...
/**
 * SrmPosChangeCertificateBfEntity_HI Entity Object
 * Thu Mar 15 16:21:26 CST 2018  Auto Generate
 */
@Entity
@Table(name = "srm_pos_change_certificate_bf")
public class SrmPosChangeCertificateBfEntity_HI {
    private Integer changeCertificateBfId; //认证证书变更前ID
	...
	@Column(name = "change_certificate_bf_id", nullable = false, length = 11)	
