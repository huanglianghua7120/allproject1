...
/**
 * SrmPosFrozenCategoriesEntity_HI Entity Object
 * Sun Mar 18 11:17:40 CST 2018  Auto Generate
 */
@Entity
@Table(name = "srm_pos_frozen_categories")
public class SrmPosFrozenCategoriesEntity_HI {
	...
	@Id
	@SequenceGenerator(name = "SRM_POS_FROZEN_CATEGORIES_S", sequenceName = "SRM_POS_FROZEN_CATEGORIES_S", allocationSize = 1)
	@GeneratedValue(generator = "SRM_POS_FROZEN_CATEGORIES_S", strategy = GenerationType.SEQUENCE)
	@Column(name = "frozen_category_id", nullable = false, length = 11)	
	...
	@Column(name = "category_status", nullable = true, length = 50)	
