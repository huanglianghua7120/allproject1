...
/**
 * SrmPosChangeInfoEntity_HI Entity Object
 * Wed Nov 15 10:53:41 CST 2017  Auto Generate
 */
@Entity
@Table(name = "srm_pos_change_info")
public class SrmPosChangeInfoEntity_HI {
    ...
    @Column(name = "change_number", nullable = true, length = 100)    
    ...
    @Column(name = "approval_opinion", nullable = true, length = 2000)
    ...
    @Column(name = "change_reason", nullable = true, length = 2000)
