...
/**
 * SrmPosSupplierContactsEntity_HI Entity Object
 * Thu Mar 29 16:58:37 CST 2018  Auto Generate
 */
@Entity
@Table(name = "srm_pos_supplier_contacts")
public class SrmPosSupplierContactsEntity_HI {
	...
	@Id
	@SequenceGenerator(name = "SRM_POS_SUPPLIER_CONTACTS_S", sequenceName = "SRM_POS_SUPPLIER_CONTACTS_S", allocationSize = 1)
	@GeneratedValue(generator = "SRM_POS_SUPPLIER_CONTACTS_S", strategy = GenerationType.SEQUENCE)
	@Column(name = "supplier_contact_id", nullable = false, length = 11)	
