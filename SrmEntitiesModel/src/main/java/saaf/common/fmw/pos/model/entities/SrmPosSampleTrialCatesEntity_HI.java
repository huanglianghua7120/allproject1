...
/**
 * SrmPosSampleTrialCatesEntity_HI Entity Object
 * Wed Nov 15 10:54:59 CST 2017  Auto Generate
 */
@Entity
@Table(name = "srm_pos_sample_trial_cates")
public class SrmPosSampleTrialCatesEntity_HI {
    ...
    @Column(name = "trial_cate_id", nullable = false, length = 11)    
    ...
    @Column(name = "big_category_code", nullable = false, length = 50)    
    ...
    @Column(name = "middle_category_code", nullable = true, length = 50)    
    ...
    @Column(name = "small_category_code", nullable = true, length = 50)    
    ...
    @Column(name = "selected_flag", nullable = false, length = 30)    
