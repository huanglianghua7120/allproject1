...
/**
 * SrmPosChangeAddressBfEntity_HI Entity Object
 * Mon Mar 19 11:49:01 CST 2018  Auto Generate
 */
@Entity
@Table(name = "srm_pos_change_address_bf")
public class SrmPosChangeAddressBfEntity_HI {
    private Integer changeAddressBfId; //供应商地址变更前ID
	...
	@Id
	@SequenceGenerator(name = "SRM_POS_CHANGE_ADDRESS_S", sequenceName = "SRM_POS_CHANGE_ADDRESS_S", allocationSize = 1)
	@GeneratedValue(generator = "SRM_POS_CHANGE_ADDRESS_S", strategy = GenerationType.SEQUENCE)
	@Column(name = "change_address_bf_id", nullable = false, length = 11)	
