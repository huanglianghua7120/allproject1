...
/**
 * SrmPosChangeContactAfEntity_HI Entity Object
 * Fri Mar 16 17:43:15 CST 2018  Auto Generate
 */
@Entity
@Table(name = "srm_pos_change_contact_af")
public class SrmPosChangeContactAfEntity_HI {
    private Integer changeContactAfId; //供应商联系人变更后ID
	...
	@Column(name = "change_contact_af_id", nullable = false, length = 11)	
