...
/**
 * SrmPosQualificationSitesEntity_HI Entity Object
 * Fri Mar 23 11:52:36 CST 2018  Auto Generate
 */
@Entity
@Table(name = "srm_pos_qualification_sites")
public class SrmPosQualificationSitesEntity_HI {
	...
	@Id
	@SequenceGenerator(name = "SRM_POS_QUALIFICATION_SITES_S", sequenceName = "SRM_POS_QUALIFICATION_SITES_S", allocationSize = 1)
	@GeneratedValue(generator = "SRM_POS_QUALIFICATION_SITES_S", strategy = GenerationType.SEQUENCE)
	@Column(name = "qualification_site_id", nullable = false, length = 11)	
