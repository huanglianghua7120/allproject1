...
/**
 * SrmPosChangeCertificateEntity_HI Entity Object
 * Wed Nov 15 10:52:38 CST 2017  Auto Generate
 */
@Entity
@Table(name = "srm_pos_change_certificate")
public class SrmPosChangeCertificateEntity_HI {
    ...
    private String longCertificateIndate;
    ...
    @Id
    @SequenceGenerator(name = "SRM_POS_CHANGE_CERTIFICATE_S", sequenceName = "SRM_POS_CHANGE_CERTIFICATE_S", allocationSize = 1)
    @GeneratedValue(generator = "SRM_POS_CHANGE_CERTIFICATE_S", strategy = GenerationType.SEQUENCE)
    @Column(name = "change_certificate_id", nullable = false, length = 11)
    ...
    @Column(name = "change_id", nullable = false, length = 30)    
    ...
    @Column(name = "certificate_id", nullable = true, length = 11)    
    ...
    @Column(name = "certificate_description", nullable = true, length = 240)    
