...
/**
 * SrmPosLocaleReviewSitesEntity_HI Entity Object
 * Tue Mar 20 14:33:39 CST 2018  Auto Generate
 */
@Entity
@Table(name = "srm_pos_locale_review_sites")
public class SrmPosLocaleReviewSitesEntity_HI {
	...
	@Column(name = "locale_review_site_id", nullable = false, length = 11)	
