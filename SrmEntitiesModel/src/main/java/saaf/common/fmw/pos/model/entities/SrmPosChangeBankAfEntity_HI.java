...
/**
 * SrmPosChangeBankAfEntity_HI Entity Object
 * Fri Mar 16 15:03:53 CST 2018  Auto Generate
 */
@Entity
@Table(name = "srm_pos_change_bank_af")
public class SrmPosChangeBankAfEntity_HI {
    private Integer changeBankAfId; //供应商银行变更后ID
	...
	@Column(name = "change_bank_af_id", nullable = false, length = 11)	
	...
	@Column(name = "bank_account_id", nullable = true, length = 11)	
