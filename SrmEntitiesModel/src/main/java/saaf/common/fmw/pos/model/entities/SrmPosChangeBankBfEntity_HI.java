...
/**
 * SrmPosChangeBankBfEntity_HI Entity Object
 * Fri Mar 16 15:03:52 CST 2018  Auto Generate
 */
@Entity
@Table(name = "srm_pos_change_bank_bf")
public class SrmPosChangeBankBfEntity_HI {
	...
	@Column(name = "change_bank_bf_id", nullable = false, length = 11)	
