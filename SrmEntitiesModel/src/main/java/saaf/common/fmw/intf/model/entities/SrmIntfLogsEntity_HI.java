...
/**
 * SrmIntfLogsEntity_HI Entity Object
 * Thu Jul 19 10:16:56 CST 2018  Auto Generate
 */
@Entity
@Table(name = "srm_intf_logs")
public class SrmIntfLogsEntity_HI {
    ...
    @Column(name = "intf_type", nullable = false, length = 30)
    ...
    @Column(name = "data_direction", nullable = true, length = 30)
    ...
    @Column(name = "send_system", nullable = true, length = 30)
    ...
    @Column(name = "receive_system", nullable = true, length = 30)
    ...
    @Column(name = "out_data", nullable = true, length = 0)
    ...
    @Column(name = "in_data", nullable = true, length = 0)
    ...
    @Column(name = "intf_status", nullable = true, length = 30)
    ...
    @Column(name = "error_msg", nullable = true, length = 0)
