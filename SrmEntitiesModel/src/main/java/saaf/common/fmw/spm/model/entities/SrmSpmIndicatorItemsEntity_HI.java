...
/**
 * SrmSpmIndicatorItemsEntity_HI Entity Object
 * Tue Mar 06 08:54:43 CST 2018  Auto Generate
 */
@Entity
@Table(name = "srm_spm_indicator_items")
public class SrmSpmIndicatorItemsEntity_HI {
	...
	@Id
	@SequenceGenerator(name = "SRM_SPM_INDICATOR_ITEMS_S", sequenceName = "SRM_SPM_INDICATOR_ITEMS_S", allocationSize = 1)
	@GeneratedValue(generator = "SRM_SPM_INDICATOR_ITEMS_S", strategy = GenerationType.SEQUENCE)
	@Column(name = "indicator_item_id", nullable = false, length = 11)	
	...
	@Column(name = "seq_number", nullable = true, length = 11)	
	...
	@Column(name = "indicator_item_desc", nullable = true, length = 30)	
	...
	@Column(name = "pk1_value", nullable = true, length = 30)	
	...
	@Column(name = "pk2_value", nullable = true, length = 30)	
	...
	@Column(name = "pk3_value", nullable = true, length = 30)	
