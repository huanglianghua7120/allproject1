...
/**
 * SrmSpmTplIndicatorOwerEntity_HI Entity Object
 * Tue Apr 03 10:47:27 GMT+08:00 2018  Auto Generate
 */
@Entity
@Table(name = "srm_spm_tpl_indicator_ower")
public class SrmSpmTplIndicatorOwerEntity_HI {
    private Integer tplIndicatorOwerId; //ID
    private Integer tplIndicatorId; //模板指标ID
    private Integer departmentId; //部门ID（备用）
    private Integer positionId; //职位ID
    private String positionCode; //职位CODE，关联表：SAAF_LOOKUP_VALUES（EMPLOYEE_POST）
	...
	@Id
	@SequenceGenerator(name = "SRM_SPM_TPL_INDICATOR_OWER_S", sequenceName = "SRM_SPM_TPL_INDICATOR_OWER_S", allocationSize = 1)
	@GeneratedValue(generator = "SRM_SPM_TPL_INDICATOR_OWER_S", strategy = GenerationType.SEQUENCE)
	@Column(name = "tpl_indicator_ower_id", nullable = false, length = 11)	
	...
	@Column(name = "position_code", nullable = true, length = 30)	
