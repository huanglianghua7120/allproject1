...
/**
 * SrmSpmTplCategoriesEntity_HI Entity Object
 * Tue Mar 06 08:54:45 CST 2018  Auto Generate
 */
@Entity
@Table(name = "srm_spm_tpl_categories")
public class SrmSpmTplCategoriesEntity_HI {
    private Integer tplCategoryId; //模板分类ID
	...
	@Id
	@SequenceGenerator(name = "SRM_SPM_TPL_CATEGORIES_S", sequenceName = "SRM_SPM_TPL_CATEGORIES_S", allocationSize = 1)
	@GeneratedValue(generator = "SRM_SPM_TPL_CATEGORIES_S", strategy = GenerationType.SEQUENCE)
	@Column(name = "tpl_category_id", nullable = false, length = 11)	
