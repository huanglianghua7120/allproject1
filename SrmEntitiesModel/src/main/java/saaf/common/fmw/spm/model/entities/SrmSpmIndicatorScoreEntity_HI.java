...
/**
 * SrmSpmIndicatorScoreEntity_HI Entity Object
 * Tue Mar 06 08:54:50 CST 2018  Auto Generate
 */
@Entity
@Table(name = "srm_spm_indicator_score")
public class SrmSpmIndicatorScoreEntity_HI {
    private Integer indicatorScoreId; //供应商指标得分ID
    private Integer supplierScoreId; //供应商分类得分ID，关联表：SRM_SPM_SUPPLIER_SCORE
	...
	@Id
	@SequenceGenerator(name = "SRM_SPM_INDICATOR_SCORE_S", sequenceName = "SRM_SPM_INDICATOR_SCORE_S", allocationSize = 1)
	@GeneratedValue(generator = "SRM_SPM_INDICATOR_SCORE_S", strategy = GenerationType.SEQUENCE)
	@Column(name = "indicator_score_id", nullable = false, length = 11)	
	...
	@Column(name = "supplier_score_id", nullable = true, length = 11)	
