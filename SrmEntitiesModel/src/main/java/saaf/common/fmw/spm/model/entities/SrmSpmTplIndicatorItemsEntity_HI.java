...
/**
 * SrmSpmTplIndicatorItemsEntity_HI Entity Object
 * Tue Mar 06 08:54:47 CST 2018  Auto Generate
 */
@Entity
@Table(name = "srm_spm_tpl_indicator_items")
public class SrmSpmTplIndicatorItemsEntity_HI {
    private Integer tplIndicatorItemId; //模板指标评分项ID
    private Integer tplIndicatorId; //模板指标ID
    private Integer indicatorItemId; //指标评分项ID，关联表：SRM_SPM_INDICATOR_ITEMS
	...
	@Id
	@SequenceGenerator(name = "SRM_SPM_TPL_INDICATOR_ITEMS_S", sequenceName = "SRM_SPM_TPL_INDICATOR_ITEMS_S", allocationSize = 1)
	@GeneratedValue(generator = "SRM_SPM_TPL_INDICATOR_ITEMS_S", strategy = GenerationType.SEQUENCE)
	@Column(name = "tpl_indicator_item_id", nullable = false, length = 11)	
