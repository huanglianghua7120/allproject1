...
/**
 * SrmSpmSupplierFeedbacksEntity_HI Entity Object
 * Tue Mar 06 08:54:51 CST 2018  Auto Generate
 */
@Entity
@Table(name = "srm_spm_supplier_feedbacks")
public class SrmSpmSupplierFeedbacksEntity_HI {
    ...
    private String improveMeasures; //改善措施
	...
	@Id
	@SequenceGenerator(name = "SRM_SPM_SUPPLIER_FEEDBACKS_S", sequenceName = "SRM_SPM_SUPPLIER_FEEDBACKS_S", allocationSize = 1)
	@GeneratedValue(generator = "SRM_SPM_SUPPLIER_FEEDBACKS_S", strategy = GenerationType.SEQUENCE)
	...
	@Column(name = "improve_measures", nullable = true, length = 500)	
