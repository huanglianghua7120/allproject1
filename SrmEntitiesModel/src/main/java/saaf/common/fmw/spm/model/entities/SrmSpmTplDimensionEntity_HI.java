...
/**
 * SrmSpmTplDimensionEntity_HI Entity Object
 * Tue Mar 06 08:54:46 CST 2018  Auto Generate
 */
@Entity
@Table(name = "srm_spm_tpl_dimension")
public class SrmSpmTplDimensionEntity_HI {
	...
	@Id
	@SequenceGenerator(name = "SRM_SPM_TPL_DIMENSION_S", sequenceName = "SRM_SPM_TPL_DIMENSION_S", allocationSize = 1)
	@GeneratedValue(generator = "SRM_SPM_TPL_DIMENSION_S", strategy = GenerationType.SEQUENCE)
	@Column(name = "tpl_dimension_id", nullable = false, length = 11)	
