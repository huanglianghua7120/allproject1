...
/**
 * SrmBaseCategoryDivisionEntity_HI Entity Object
 * Fri Mar 09 09:29:07 CST 2018  Auto Generate
 */
@Entity
@Table(name = "srm_base_category_division")
public class SrmBaseCategoryDivisionEntity_HI {
    ...
    private String allCategoryFlag; //是否可操作全品类，关联表：SAAF_LOOKUP_VALUES（YSE_NO）
	...
	@Id	
	@GeneratedValue	
	@Column(name = "division_id", nullable = false, length = 11)	
	...
	@Column(name = "all_category_flag", nullable = true, length = 30)	
	...
	@Column(name = "division_status", nullable = true, length = 30)	
