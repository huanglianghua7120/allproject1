...
/**
 * SrmBaseBranchesEntity_HI Entity Object
 * Mon Mar 12 14:23:42 CST 2018  Auto Generate
 */
@Entity
@Table(name = "srm_base_branches")
public class SrmBaseBranchesEntity_HI {
	...
	@Id
//	@SequenceGenerator(name = "SRM_BASE_BRANCHES_S", sequenceName = "SRM_BASE_BRANCHES_S", allocationSize = 1)
//	@GeneratedValue(generator = "SRM_BASE_BRANCHES_S", strategy = GenerationType.SEQUENCE)
	...
	@Column(name = "branch_code", nullable = true, length = 30)
	...
	@Column(name = "branch_name", nullable = false, length = 240)
	...
	@Column(name = "branch_address", nullable = true, length = 240)
