...
@Entity
@Table(name = "srm_base_user_categories")
public class SrmBaseUserCategoriesEntity_HI {
	...
	@Id
    @SequenceGenerator(name = "SRM_BASE_USER_CATEGORIES_S", sequenceName = "SRM_BASE_USER_CATEGORIES_S", allocationSize = 1)
    @GeneratedValue(generator = "SRM_BASE_USER_CATEGORIES_S", strategy = GenerationType.SEQUENCE)
