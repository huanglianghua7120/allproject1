...
@Entity
@Table(name = "srm_okc_contract_items")
public class SrmOkcContractItemsEntity_HI {
	...
	@Id
    @SequenceGenerator(name = "SRM_OKC_CONTRACT_ITEMS_S", sequenceName = "SRM_OKC_CONTRACT_ITEMS_S", allocationSize = 1)
    @GeneratedValue(generator = "SRM_OKC_CONTRACT_ITEMS_S", strategy = GenerationType.SEQUENCE)
    ...
    @Column(name = "transferred_po_quantity")
    ...
    @Column(name = "contract_item_comments")
