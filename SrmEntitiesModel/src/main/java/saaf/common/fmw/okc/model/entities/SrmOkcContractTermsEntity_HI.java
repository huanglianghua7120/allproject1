...
/**
 * SrmOkcContractTermsEntity_HI Entity Object
 * Mon May 27 09:41:40 CST 2019  Auto Generate
 */
@Entity
@Table(name = "srm_okc_contract_terms")
public class SrmOkcContractTermsEntity_HI {
	...
	@Id
	@SequenceGenerator(name = "SRM_OKC_CONTRACT_TERMS_S", sequenceName = "SRM_OKC_CONTRACT_TERMS_S", allocationSize = 1)
	@GeneratedValue(generator = "SRM_OKC_CONTRACT_TERMS_S", strategy = GenerationType.SEQUENCE)
	@Column(name = "term_id", nullable = false, length = 11)	
	...
	@Column(name = "term_name", nullable = false, length = 240)	
	...
	@Column(name = "term_status", nullable = true, length = 30)	
	...
	@Column(name = "term_content", nullable = false, length = 2000)	
