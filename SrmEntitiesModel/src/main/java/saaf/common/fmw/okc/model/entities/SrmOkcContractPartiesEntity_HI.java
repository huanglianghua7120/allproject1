...
@Entity
@Table(name = "srm_okc_contract_parties")
public class SrmOkcContractPartiesEntity_HI {
	...
	@Id
    @SequenceGenerator(name = "SRM_OKC_CONTRACT_PARTIES_S", sequenceName = "SRM_OKC_CONTRACT_PARTIES_S", allocationSize = 1)
    @GeneratedValue(generator = "SRM_OKC_CONTRACT_PARTIES_S", strategy = GenerationType.SEQUENCE)
    ...
    @Column(name = "contract_party_role")
