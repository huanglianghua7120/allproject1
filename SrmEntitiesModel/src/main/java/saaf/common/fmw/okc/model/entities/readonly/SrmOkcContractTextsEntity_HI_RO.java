...
public class SrmOkcContractTextsEntity_HI_RO implements Serializable {

    public static String SRM_OKC_CONTRACT_TEXTS_QUERY_SQL = "select " +
   "   t.contract_text_id as contractTextId ,  \r\n" +
   "   t.contract_id as contractId ,  \r\n" +
   "   t.text_file_id as textFileId ,  \r\n" +
   "   t.text_file_name as textFileName ,  \r\n" +
   "   t.template_modify_flag as templateModifyFlag ,  \r\n" +
   ...
   "   f.access_Path as accessPath , f.group_Name as groupName , f.remote_FileName as remoteFileName " +
    "    		  FROM srm_okc_contract_texts t  \r\n" +
            "INNER JOIN  saaf_users u  on u.user_id = t.created_by \r\n" +
            "LEFT JOIN  saaf_base_result_file f on t.text_file_id = f.file_id \r\n"+
    ...
    public SrmOkcContractTextsEntity_HI_RO(){
        super();
    }
