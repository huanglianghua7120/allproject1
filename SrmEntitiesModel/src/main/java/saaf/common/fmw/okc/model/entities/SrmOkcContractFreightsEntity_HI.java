...
@Entity
@Table(name = "srm_okc_contract_freights")
public class SrmOkcContractFreightsEntity_HI {
	...
	@Id
    @SequenceGenerator(name = "SRM_OKC_CONTRACT_FREIGHTS_S", sequenceName = "SRM_OKC_CONTRACT_FREIGHTS_S", allocationSize = 1)
    @GeneratedValue(generator = "SRM_OKC_CONTRACT_FREIGHTS_S", strategy = GenerationType.SEQUENCE)
    @Column(name = "contract_freight_id")
