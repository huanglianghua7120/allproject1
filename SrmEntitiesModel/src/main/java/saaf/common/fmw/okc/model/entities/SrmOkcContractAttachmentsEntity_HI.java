...
@Entity
@Table(name = "srm_okc_contract_attachments")
public class SrmOkcContractAttachmentsEntity_HI {
	...
	@Id
    @SequenceGenerator(name = "SRM_OKC_CONTRACT_ATTACHMENT_S", sequenceName = "SRM_OKC_CONTRACT_ATTACHMENT_S", allocationSize = 1)
    @GeneratedValue(generator = "SRM_OKC_CONTRACT_ATTACHMENT_S", strategy = GenerationType.SEQUENCE)
