...
@Entity
@Table(name = "srm_okc_freight_expenses")
public class SrmOkcFreightExpensesEntity_HI {
	...
	@Id
    @SequenceGenerator(name = "SRM_OKC_FREIGHT_EXPENSES_S", sequenceName = "SRM_OKC_FREIGHT_EXPENSES_S", allocationSize = 1)
    @GeneratedValue(generator = "SRM_OKC_FREIGHT_EXPENSES_S", strategy = GenerationType.SEQUENCE)
    @Column(name = "freight_expense_id")
