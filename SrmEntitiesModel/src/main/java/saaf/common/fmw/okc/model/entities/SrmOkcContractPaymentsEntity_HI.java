...
@Entity
@Table(name = "srm_okc_contract_payments")
public class SrmOkcContractPaymentsEntity_HI {
	...
	@Id
    @SequenceGenerator(name = "SRM_OKC_CONTRACT_PAYMENTS_S", sequenceName = "SRM_OKC_CONTRACT_PAYMENTS_S", allocationSize = 1)
    @GeneratedValue(generator = "SRM_OKC_CONTRACT_PAYMENTS_S", strategy = GenerationType.SEQUENCE)
    ...
    @Column(name = "payment_stage_name")
    ...
    @Column(name = "payment_stage_explain")
    ...
    @Column(name = "payment_proportion")
    ...
    @Column(name = "estimate_payment_date")
    ...
    @Column(name = "warning_advance_days")
    ...
    @Column(name = "payment_completed_flag")
