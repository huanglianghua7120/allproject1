...
/**
 * SrmOkcWatermarksEntity_HI Entity Object
 * Mon May 27 09:41:41 CST 2019  Auto Generate
 */
@Entity
@Table(name = "srm_okc_watermarks")
public class SrmOkcWatermarksEntity_HI {
	...
	@Id
	@SequenceGenerator(name = "SRM_OKC_WATERMARKS_S", sequenceName = "SRM_OKC_WATERMARKS_S", allocationSize = 1)
	@GeneratedValue(generator = "SRM_OKC_WATERMARKS_S", strategy = GenerationType.SEQUENCE)
	@Column(name = "watermark_id", nullable = false, length = 11)	
	...
	@Column(name = "watermark_code", nullable = false, length = 30)	
	...
	@Column(name = "watermark_name", nullable = false, length = 240)	
	...
	@Column(name = "watermark_file_id", nullable = false, length = 11)	
