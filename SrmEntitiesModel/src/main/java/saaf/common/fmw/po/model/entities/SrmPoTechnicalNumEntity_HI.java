...
/**
 * SrmPoTechnicalNumEntity_HI Entity Object
 * Sat Jun 27 14:50:48 CST 2020  Auto Generate
 */
@Entity
@Table(name="SRM_PO_TECHNICAL_NUM")
public class SrmPoTechnicalNumEntity_HI {
    ...
    @Id
    @SequenceGenerator(name = "SRM_PO_TECHNICAL_NUM_S", sequenceName = "SRM_PO_TECHNICAL_NUM_S", allocationSize = 1)
    @GeneratedValue(generator = "SRM_PO_TECHNICAL_NUM_S", strategy = GenerationType.SEQUENCE)
	...
	@Column(name="technical_code", nullable=false, length=30)	
	...
	@Column(name="technical_name", nullable=false, length=240)	
