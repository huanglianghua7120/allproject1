...
/**
 * SrmPoPlanDemandsEntity_HI Entity Object Wed Dec 06 16:45:08 CST 2017 Auto
 * Generate
 */
@Entity
@Table(name = "SRM_PO_PLAN_DEMANDS")
public class SrmPoPlanDemandsEntity_HI {
	private Integer planDemandId;
	private Integer planDemandNum;
	...
	@Column(name = "plan_demand_num", nullable = false, length = 11)
	public Integer getPlanDemandNum() {
		return planDemandNum;
	}

	public void setPlanDemandNum(Integer planDemandNum) {
		this.planDemandNum = planDemandNum;
	}

	@Column(name = "supply_inst_id", nullable = false, length = 11)
	...
	@Column(name = "handle_status", nullable = true, length = 500)
