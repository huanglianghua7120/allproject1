...
/**
 * SrmPoRecruitmentHeaderEntity_HI Entity Object
 * Wed Jul 29 14:27:45 CST 2020  Auto Generate
 */
@Entity
@Table(name="srm_po_recruitment_header")
public class SrmPoRecruitmentHeaderEntity_HI {
	...
	@Id
	@SequenceGenerator(name = "SRM_PO_RECRUITMENT_HEADER_S", sequenceName = "SRM_PO_RECRUITMENT_HEADER_S", allocationSize = 1)
	@GeneratedValue(generator = "SRM_PO_RECRUITMENT_HEADER_S", strategy = GenerationType.SEQUENCE)
	...
	@Column(name="recruitment_code", nullable=false, length=240)	
