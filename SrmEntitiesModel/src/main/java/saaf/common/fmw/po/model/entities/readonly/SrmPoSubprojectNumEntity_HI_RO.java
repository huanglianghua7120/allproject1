...
/**
 * SrmPoSubprojectNumEntity_HI_RO Entity Object
 * Sat Jun 27 14:50:55 CST 2020  Auto Generate
 */

public class SrmPoSubprojectNumEntity_HI_RO {

    public static String QUERY_SUBPROJECT_NUM_SQL ="SELECT Spsn.Subproject_Id\n" +
            "      ,Spsn.subproject_code\n" +
            "      ,Spsn.subproject_name\n" +
            "      ,Spsn.technical_id\n" +
            "      ,Spsn.source_id\n" +
            "      ,Spsn.enable\n" +
            "      ,decode(Spsn.Enable,'Y','生效','失效') as enableName\n" +
            "      ,Spsn.effective_date\n" +
            "      ,Spsn.expiration_date\n" +
            "      ,Spsn.version_num\n" +
            "      ,Spsn.creation_date\n" +
            "      ,Spsn.created_by\n" +
            "  FROM Srm_Po_Subproject_Num Spsn\n" +
            " WHERE 1 = 1";
