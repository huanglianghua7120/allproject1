...
/**
 * SrmPoHeaderArchivesEntity_HI Entity Object
 * Thu Mar 21 09:56:42 CST 2019  Auto Generate
 */
@Entity
@Table(name = "srm_po_header_archives")
public class SrmPoHeaderArchivesEntity_HI {
	private Integer poArchiveId;//采购历史头ID
	...
	@Id
	@SequenceGenerator(name = "SRM_PO_HEADER_ARCHIVES_S", sequenceName = "SRM_PO_HEADER_ARCHIVES_S", allocationSize = 1)
	@GeneratedValue(generator = "SRM_PO_HEADER_ARCHIVES_S", strategy = GenerationType.SEQUENCE)
