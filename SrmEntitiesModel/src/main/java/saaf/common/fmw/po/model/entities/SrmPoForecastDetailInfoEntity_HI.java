...
/**
 * SrmPoForecastDetailInfoEntity_HI Entity Object
 * Wed Nov 15 10:57:02 CST 2017  Auto Generate
 */
@Entity
@Table(name = "srm_po_forecast_detail_info")
public class SrmPoForecastDetailInfoEntity_HI {
    ...
    @Id
    @SequenceGenerator(name = "SRM_PO_FORECAST_DETAIL_INFO_S", sequenceName = "SRM_PO_FORECAST_DETAIL_INFO_S", allocationSize = 1)
    @GeneratedValue(generator = "SRM_PO_FORECAST_DETAIL_INFO_S", strategy = GenerationType.SEQUENCE)
    @Column(name = "forecast_detail_id", nullable = false, length = 11)    
    ...
    @Column(name = "forecast_id", nullable = false, length = 30)    
