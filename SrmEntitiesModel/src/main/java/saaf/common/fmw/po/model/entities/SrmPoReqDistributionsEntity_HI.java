...
/**
 * SrmPoReqDistributionsEntity_HI Entity Object
 * Tue Jun 26 16:15:05 CST 2018  Auto Generate
 */
@Entity
@Table(name = "srm_po_req_distributions")
public class SrmPoReqDistributionsEntity_HI {
    ...
    @Id
    @SequenceGenerator(name = "SRM_PO_REQ_DISTRIBUTIONS_S", sequenceName = "SRM_PO_REQ_DISTRIBUTIONS_S", allocationSize = 1)
    @GeneratedValue(generator = "SRM_PO_REQ_DISTRIBUTIONS_S", strategy = GenerationType.SEQUENCE)
    @Column(name = "req_distribution_id", nullable = false, length = 11)    
    ...
    @Column(name = "distribution_proportion", precision = 5, scale = 2)    
