 ...
 */
@Entity
@Table(name = "srm_po_lines")
public class SrmPoLinesEntity_HI {
	...
	@Id
	@SequenceGenerator(name = "SRM_PO_LINES_S", sequenceName = "SRM_PO_LINES_S", allocationSize = 1)
	@GeneratedValue(generator = "SRM_PO_LINES_S", strategy = GenerationType.SEQUENCE)
