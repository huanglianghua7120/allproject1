...
/**
 * SrmPoRecruitArchivesLEntity_HI Entity Object
 * Thu Jul 30 11:29:25 CST 2020  Auto Generate
 */
@Entity
@Table(name="srm_po_recruit_archives_l")
public class SrmPoRecruitArchivesLEntity_HI {
	...
	@Id
	@SequenceGenerator(name = "SRM_PO_RECRUIT_ARCHIVES_L_S", sequenceName = "SRM_PO_RECRUIT_ARCHIVES_L_S", allocationSize = 1)
	@GeneratedValue(generator = "SRM_PO_RECRUIT_ARCHIVES_L_S", strategy = GenerationType.SEQUENCE)
	@Column(name="archives_line_id", nullable=false, length=22)	
	...
	@Column(name="recruitment_line_id", nullable=true, length=22)
	...
	@Column(name="recruitment_header_id", nullable=true, length=22)
	...
	@Column(name="recruitment_description", nullable=true, length=2000)	
	...
	@Column(name="original_demand_num", nullable=true, length=22)	
