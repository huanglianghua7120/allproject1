...
/**
 * SrmPoChangeInfoHisEntity_HI Entity Object
 * Sat Dec 30 10:59:22 CST 2017  Auto Generate
 */
@Entity
@Table(name = "srm_po_change_info_his")
public class SrmPoChangeInfoHisEntity_HI {
    ...
    @Column(name = "po_change_id", nullable = true, length = 11)    
