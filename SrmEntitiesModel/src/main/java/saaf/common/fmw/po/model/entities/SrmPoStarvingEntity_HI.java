...
/**
 * SrmPoStarvingEntity_HI Entity Object
 * Thu Dec 07 15:18:17 CST 2017  Auto Generate
 */
@Entity
@Table(name = "srm_po_starving")
public class SrmPoStarvingEntity_HI {
    ...
    @Column(name = "notice_qty", precision = 20, scale = 6)
