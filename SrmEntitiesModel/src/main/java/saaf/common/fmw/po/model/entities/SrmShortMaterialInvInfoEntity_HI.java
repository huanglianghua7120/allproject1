...
/**
 * SrmShortMaterialInvInfoEntity_HI Entity Object Sun Dec 31 11:58:15 CST 2017
 * Auto Generate
 */
@Entity
@Table(name = "SRM_SHORT_MATERIAL_INV_INFO")
public class SrmShortMaterialInvInfoEntity_HI {
	private Integer id;
	...
	@Column(name = "total_actqty", precision = 24, scale = 9)
	...
	@Column(name = "total_issuedqty", precision = 24, scale = 9)
	...
	@Column(name = "midqty", precision = 24, scale = 9)
