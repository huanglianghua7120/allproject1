...
/**
 * SrmPrcMappingHeadersEntity_HI Entity Object
 * Mon Feb 05 16:27:31 CST 2018  Auto Generate
 */
@Entity
@Table(name = "srm_prc_mapping_headers")
public class SrmPrcMappingHeadersEntity_HI {
    ...
    @Column(name = "mapping_status", nullable = true, length = 30)    
