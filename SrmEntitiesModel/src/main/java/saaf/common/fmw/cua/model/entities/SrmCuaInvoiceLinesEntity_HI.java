...
/**
 * SrmCuaInvoiceLinesEntity_HI Entity Object
 * Fri Nov 09 17:08:43 CST 2018  Auto Generate
 */
@Entity
@Table(name = "srm_cua_invoice_lines")
public class SrmCuaInvoiceLinesEntity_HI {
	...
	@Column(name = "invoice_line_id", nullable = false, length = 22)	
