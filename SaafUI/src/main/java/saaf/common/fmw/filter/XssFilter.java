...
//			}
			// 校验是否存在SQL注入信息
//			if (checkJSInject(paramVale, url)) {
...
//			}
	...
	public void init(FilterConfig filterconfig1) throws ServletException {
		...
		noticeUrls.add("saveReleaseNotices");
		noticeUrls.add("saveNotices");
	}
	 ...
	 */
	public static boolean checkJSInject(String str, String url) {
		if (StringUtils.isEmpty(str)) {
			return false;// 如果传入空串则认为不存在非法字符
		}
		// 判断黑名单"master" , "mid", "truncate", "insert", "select", "delete", "update", "declare",
		String[] inj_stra = { "script","iframe", "onreadystatechange", "alert", "atestu", "xss", "'", "<", ">", "svg", "confirm", "prompt", "onload", "onmouseover", "onfocus", "onerror" };
